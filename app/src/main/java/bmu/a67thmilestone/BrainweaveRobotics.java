...
public class BrainweaveRobotics extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.brainweave_robotics);
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                  favouritesdatabase fd = new favouritesdatabase("Brainweave Robotics Workshop","5th April | 12:30 pm","NB-106");
    ...
    public void rules(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.67thmilestone.com/download/RoboticsWorkshop/docx"));
        startActivity(intent);
    ...
    public void email2(View v) {
        String[] addresses = {"mayank.gupta.14cs@bml.edu.in"};
    ...
    public void call1(View v) {
        dialPhoneNumber("9779433340");
    }

    public void call2(View v) {
        dialPhoneNumber("7508807490");
    }
