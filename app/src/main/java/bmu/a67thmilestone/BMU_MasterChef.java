...
public class BMU_MasterChef extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_bmu__master_chef );
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                  favouritesdatabase fd = new favouritesdatabase("BMU MasterChef'18","6th April | 10:00 am","E2 Building - Homeland/ Hall of");
    ...
    public void rules(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://67thmilestone.com/download/BMU_MasterChef/docx"));
        startActivity(intent);
    ...
    public void email1(View v) {
        String[] addresses = {"n.rama.15csc@bml.edu.in"};
    ...
    public void email2(View v) {
        String[] addresses = {"solasa.sai.16ece@bml.edu.in"};
    ...
    public void call1(View v) {
        dialPhoneNumber("9996599467");
    }

    public void call2(View v) {
        dialPhoneNumber("8555979835");
    }
