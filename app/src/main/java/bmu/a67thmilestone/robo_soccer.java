...
public class robo_soccer extends AppCompatActivity {
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                  favouritesdatabase fd = new favouritesdatabase("Robo Soccer","7th April | 10:00 am","Amphitheatre - Curb Your");
    ...
    public void rules(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://67thmilestone.com/download/Robo_Soccer_Robotics/pdf"));
        startActivity(intent);
