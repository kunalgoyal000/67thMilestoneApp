...
public class fashion_crave extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fashion_crave);
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                  favouritesdatabase fd = new favouritesdatabase("Fashion Crave","5th April | 1:00 pm","MPH - La La Land");
    ...
    public void rules(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.67thmilestone.com/download/PANACHE_RULES_Fashion_Crave/pdf"));
        startActivity(intent);
...
//    }
    public void email1(View v) {
        String[] addresses = {"sharvirala.kinnera.16ece@bml.edu.in"};
    ...
    public void email2(View v) {
        String[] addresses = {"ande.varun.16ece@bml.edu.in"};
    ...
    public void call1(View v) {
        dialPhoneNumber("8295058065");
    }

    public void call2(View v) {
        dialPhoneNumber("8295025857");
    }
