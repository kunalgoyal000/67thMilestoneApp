...
public class Battle_of_Gamerz extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_battle_of__gamerz );
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("Battle of Gamerz","5th April | 11:00 am","Computer Lab - Silicon Valley");
    ...
    public void rules(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://67thmilestone.com/download/Battle_of_Gamerz/docx"));
        startActivity(intent);
    ...
    public void email1(View v) {
        String[] addresses = {"abhinav.singh.16ece@bml.edu.in"};
    ...
    public void email2(View v) {
        String[] addresses = {"bhavishya.gupta.16ece@bml.edu.in"};
    ...
    public void call1(View v) {
        dialPhoneNumber("8005452478");
    }

    public void call2(View v) {
        dialPhoneNumber("8295014922");
    }
