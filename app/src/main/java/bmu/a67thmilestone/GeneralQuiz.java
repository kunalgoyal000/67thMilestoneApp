...
public class GeneralQuiz extends AppCompatActivity {
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                  favouritesdatabase fd = new favouritesdatabase("General Quiz","6th April | 4:00 pm","N.A.s");
    ...
    public void rules(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://67thmilestone.com/download/General_Quiz/docx"));
        startActivity(intent);

    }

    public void email9(View v) {
        String[] addresses = {"sai.sandeep.16csc@bml.edu.in"};

        String subject = "Fest";
        composeEmail(addresses, subject);
    }

    public void email10(View v) {
    ...
    public void call9(View v) {
        dialPhoneNumber("9398514771");
    }

    public void call10(View v) {
        dialPhoneNumber("8571967919");
    }
