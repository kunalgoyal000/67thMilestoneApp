...
public class battle_of_bands extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.battle_of_bands);
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("Battle of The Bands","5th April | 4:00 pm","Main Field - Empire Field");
...
//        Uri gmmIntentUri = Uri.parse("geo:0,0?q=28.248323,76.814955");
