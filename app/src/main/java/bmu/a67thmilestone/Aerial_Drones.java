...
public class Aerial_Drones extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_aerial__drones );
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                  favouritesdatabase fd = new favouritesdatabase("Aerial Drones","7th April | 9:00 am","Main Field - School of Rock");
    ...
    public void rules(View v){
        Intent i=new Intent( Intent.ACTION_VIEW,Uri.parse( "https://67thmilestone.com/download/Aerial_Drones/pdf" ) );
        startActivity( i );
    }


    public void email1(View v) {
        String[] addresses = {"prameela.kukkapalli.15cse@bml.edu.in"};
    ...
    public void email2(View v) {
        String[] addresses = {"sai.samba.16mec@bml.edu.in"};
    ...
    public void call1(View v) {
        dialPhoneNumber("9996059792");
    }

    public void call2(View v) {
        dialPhoneNumber("8295042848");
    }
