...
public class Kairos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("Kairos","5th April | 10:00 am","N.A.");
...
//    }
    ...
    public void email1(View v) {
        String[] addresses = {"ns.bhargava.15cse@bml.edu.in"};
    ...
    public void email2(View v) {
        String[] addresses = {"tushar.singh.16mec@bml.edu.in"};
    ...
    public void call1(View v) {
        dialPhoneNumber("9996599152");
    }

    public void call2(View v) {
        dialPhoneNumber("8377875054");
    }
