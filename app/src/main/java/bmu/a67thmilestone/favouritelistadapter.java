...
class favoritelistadapter extends ArrayAdapter<String> {
    ...
    favoritelistadapter(Activity context, String[] name, String[] time,String[] place) {
        ...
        super(context, R.layout.favouriteslist, name);
    ...
    favoritelistadapter(Activity context) {
        ...
        super(context, R.layout.favouriteslist);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.favouriteslist, null, true);

        TextView textViewName = (TextView) listViewItem.findViewById(R.id.name1);
        ...
        TextView textviewdate = (TextView) listViewItem.findViewById(R.id.date1);
...

    {
        ...
        TextView name = (TextView) ll.findViewById(R.id.name1);
