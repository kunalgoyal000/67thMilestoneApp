...
public class planet_power_challenge extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.planet_power_challenge);
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                  favouritesdatabase fd = new favouritesdatabase("Planet Power Challenge","5th April | 11:00 am","Auditorium - Broadway");
    ...
    public void rules(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://67thmilestone.com/download/HFE_UojvJ0A/pdf"));
        startActivity(intent);

    }

//    public void venue1(View v) {
//        Uri gmmIntentUri = Uri.parse("geo:0,0?q=28.247500,76.814479");
...
//    }
    ...
    public void email1(View v) {
        String[] addresses = {"himanshi.thawrani.16cse@bml.edu.in"};
    ...
    public void email2(View v) {
        String[] addresses = {"danish.jameel.15csc@bml.edu.in"};
    ...
    public void call1(View v) {
        dialPhoneNumber("8853173402");
    }

    public void call2(View v) {
        dialPhoneNumber("8376817125");
    }
