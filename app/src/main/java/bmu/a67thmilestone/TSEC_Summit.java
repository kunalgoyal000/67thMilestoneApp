...
public class TSEC_Summit extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_tsec__summit );
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                  favouritesdatabase fd = new favouritesdatabase("TSEC Summit","7th April | 9:30 am","Auditorium - Broadway");
    ...
    public void rules(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://67thmilestone.com/download/TSEC_SUMMIT_woTRF7w/docx"));
        startActivity(intent);
    ...
    public void email1(View v) {
        String[] addresses = {"bhanu.prakash.16mec@bml.edu.in"};
    ...
    public void email2(View v) {
        String[] addresses = {"abhishek.lomsh.15cse@bml.edu.in"};
    ...
    public void call1(View v) {
        dialPhoneNumber("9672142758");
    }

    public void call2(View v) {
        dialPhoneNumber("9478333334");
    }
