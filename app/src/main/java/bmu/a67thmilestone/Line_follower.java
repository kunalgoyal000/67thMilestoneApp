...
public class Line_follower extends AppCompatActivity {
        ...
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                  favouritesdatabase fd = new favouritesdatabase("Line Follower","6th April | 11:00 am","NB-106 - GetSmart");
    ...
    public void rules(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://67thmilestone.com/download/Line_Follower_Robotics/pdf"));
        startActivity(intent);
    ...
    public void email1(View v) {
        String[] addresses = {"karanati.veerendranath.16cse@bml.edu.in"};
    ...
    public void email2(View v) {
        String[] addresses = {"dammala.shetty.17mec@bml.edu.in"};
    ...
    public void call1(View v) {
        dialPhoneNumber("9729163930");
    }

    public void call2(View v) {
        dialPhoneNumber("9347871100");
    }
